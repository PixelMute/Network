...
at::Tensor kernel_upsample_tensor = torch::from_blob(kernel_upsample, {1, 1, 112}, torch::TensorOptions().dtype(torch::kFloat64));
at::Tensor kernel_downsample_tensor = torch::from_blob(kernel_downsample, {1, 1, 112}, torch::TensorOptions().dtype(torch::kFloat64));
...
// This frees itself due to how pytorch is set up.
struct DenoiserStatePyTorch
{
   // Encoders
   torch::nn::Conv1d encoder_0_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(1, 4, 8).stride(STRIDE));
   torch::nn::Conv1d encoder_0_2 = torch::nn::Conv1d(torch::nn::Conv1dOptions(4, 8, 1).stride(1));
   torch::nn::Conv1d encoder_1_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(4, 8, 8).stride(STRIDE));
   torch::nn::Conv1d encoder_1_2 = torch::nn::Conv1d(torch::nn::Conv1dOptions(8, 16, 1).stride(1));
   torch::nn::Conv1d encoder_2_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(8, 16, 8).stride(STRIDE));
   torch::nn::Conv1d encoder_2_2 = torch::nn::Conv1d(torch::nn::Conv1dOptions(16, 32, 1).stride(1));
   torch::nn::Conv1d encoder_3_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(16, 32, 8).stride(STRIDE));
   torch::nn::Conv1d encoder_3_2 = torch::nn::Conv1d(torch::nn::Conv1dOptions(32, 64, 1).stride(1));

   // LSTM layer
   torch::nn::LSTM lstm = torch::nn::LSTM(torch::nn::LSTMOptions(HIDDEN, HIDDEN).num_layers(LAYERS));

   // Decoders
   torch::nn::Conv1d decoder_0_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(32, 64, 1).stride(1));
   torch::nn::ConvTranspose1d decoder_0_2 = torch::nn::ConvTranspose1d(torch::nn::ConvTranspose1dOptions(32, 16, 8).stride(STRIDE));
   torch::nn::Conv1d decoder_1_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(16, 32, 1).stride(1));
   torch::nn::ConvTranspose1d decoder_1_2 = torch::nn::ConvTranspose1d(torch::nn::ConvTranspose1dOptions(16, 8, 8).stride(STRIDE));
   torch::nn::Conv1d decoder_2_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(8, 16, 1).stride(1));
   torch::nn::ConvTranspose1d decoder_2_2 = torch::nn::ConvTranspose1d(torch::nn::ConvTranspose1dOptions(8, 4, 8).stride(STRIDE));
   torch::nn::Conv1d decoder_3_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(4, 8, 1).stride(1));
   torch::nn::ConvTranspose1d decoder_3_2 = torch::nn::ConvTranspose1d(torch::nn::ConvTranspose1dOptions(4, 1, 8).stride(STRIDE));
};

void mallocDenoiserStatePyTorch(DenoiserStatePyTorch* dspt)
{
   // Encoders
   dspt->encoder_0_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(1, 4, 8).stride(STRIDE));
   dspt->encoder_0_2 = torch::nn::Conv1d(torch::nn::Conv1dOptions(4, 8, 1).stride(1));
   dspt->encoder_1_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(4, 8, 8).stride(STRIDE));
   dspt->encoder_1_2 = torch::nn::Conv1d(torch::nn::Conv1dOptions(8, 16, 1).stride(1));
   dspt->encoder_2_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(8, 16, 8).stride(STRIDE));
   dspt->encoder_2_2 = torch::nn::Conv1d(torch::nn::Conv1dOptions(16, 32, 1).stride(1));
   dspt->encoder_3_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(16, 32, 8).stride(STRIDE));
   dspt->encoder_3_2 = torch::nn::Conv1d(torch::nn::Conv1dOptions(32, 64, 1).stride(1));

   // LSTM layer
   dspt->lstm = torch::nn::LSTM(torch::nn::LSTMOptions(HIDDEN, HIDDEN).num_layers(LAYERS));

   // Decoders
   dspt->decoder_0_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(32, 64, 1).stride(1));
   dspt->decoder_0_2 = torch::nn::ConvTranspose1d(torch::nn::ConvTranspose1dOptions(32, 16, 8).stride(STRIDE));
   dspt->decoder_1_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(16, 32, 1).stride(1));
   dspt->decoder_1_2 = torch::nn::ConvTranspose1d(torch::nn::ConvTranspose1dOptions(16, 8, 8).stride(STRIDE));
   dspt->decoder_2_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(8, 16, 1).stride(1));
   dspt->decoder_2_2 = torch::nn::ConvTranspose1d(torch::nn::ConvTranspose1dOptions(8, 4, 8).stride(STRIDE));
   dspt->decoder_3_0 = torch::nn::Conv1d(torch::nn::Conv1dOptions(4, 8, 1).stride(1));
   dspt->decoder_3_2 = torch::nn::ConvTranspose1d(torch::nn::ConvTranspose1dOptions(4, 1, 8).stride(STRIDE));
}